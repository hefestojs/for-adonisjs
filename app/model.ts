...
export default class AppModel extends BaseModel {
    ...
    static jsonSchema() {
        ...
        this['$relationsDefinitions'].forEach((relationsDefinition, key: string) => {
            ...
            this.schema.relations[key]['properties'] = this.setSchemaProperties(relationsDefinition.relatedModel()['$columnsDefinitions'])
        });
    ...
    static queryWith(join: any = {}, orderby: any = {}) {
    ...
    static async pagination({ where = {}, join = {}, order = {}, page = 1, limit = 100, baseUrl = '' }: { where?: any, join?: any, order?: any, page?: number, limit?: number, baseUrl?: string}) {
        if(baseUrl === ''){
