...
export default class ForgeController extends BaseCommand {
  ...
  async run() {
    ...
    tables.forEach((each: any) => {
      ...
      if (this.openapi) content += `  ${this.openapiSpecs('index', endpointPath, modelName)}\n`
      ...
      if (this.openapi) content += `  ${this.openapiSpecs('store', endpointPath, modelName)}\n`
      ...
      if (this.openapi) content += `  ${this.openapiSpecs('show', endpointPath, modelName)}\n`
      ...
      if (this.openapi) content += `  ${this.openapiSpecs('update', endpointPath, modelName)}\n`
      ...
      if (this.openapi) content += `  ${this.openapiSpecs('destroy', endpointPath, modelName)}\n`
